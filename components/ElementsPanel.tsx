    ...
    return(<div className={`elements-panel ${isDarkMode ? 'dark-mode' : ''}`}>
        ...
        <div className='figures'>
            <div
                ...
                className={`${alignment === 'top' ? 'active-tool' : ''}`}
                >
            ...
            <div
                ...
                className={`${alignment === 'center' ? 'active-tool' : ''}`}
                >
                   <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                ...
                className={`${alignment === 'bottom' ? 'active-tool' : ''}`}
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                ...
                className={`${alignment === 'left' ? 'active-tool' : ''}`}
                >
                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                ...
                className={`${alignment === 'right' ? 'active-tool' : ''}`}
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
