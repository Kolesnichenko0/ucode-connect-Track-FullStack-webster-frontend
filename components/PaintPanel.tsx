...
export default function PaintPanel({ paintTool, setPaintTool, paintSettings, setPaintSettings }) {
    ...
    return(<div className='paint-panel'> 
        <h2>Tools</h2>
        <div className='tools'>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="32" viewBox="0 0 24 24" onClick={() => setPaintTool('brush')} className={paintTool === 'brush' ? 'active-tool' : ''}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="32" viewBox="0 0 24 24" onClick={() => setPaintTool('eraser')} className={paintTool === 'eraser' ? 'active-tool' : ''}>
