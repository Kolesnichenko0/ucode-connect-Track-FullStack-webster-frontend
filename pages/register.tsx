...
export default function Register() {
  ...
  return (
    <>
      ...
      <div className="min-h-[900px] w-full bg-white dark:bg-black text-black dark:text-white flex items-center justify-center">
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className='w-full h-12 rounded-lg text-center flex items-center justify-center'
                    >
                      <svg className='mr-5' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
